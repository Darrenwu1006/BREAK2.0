...
- [Claude 2026-07-16] 動工前先列出本次預計修改的檔案清單與理由；實作中發現要動清單外的檔案時，先說明再動。（源自 0709 code principle 討論）
- [Claude 2026-07-16] 單輪 diff 明顯超出宣告範圍、或混入多個不相干關注點時，先停下來拆成多個小步再繼續，不邊做邊擴 scope。（源自 0709 code principle 討論）
